                ...
                <div className="p-4 md:p-8 lg:p-12 items-center text-center">
                  ...
                  <FadeIn delay={0.4} direction="up" duration={0.8} once={true}>
                    <p className="mt-4 text-sm md:text-base text-black max-w-2xl">
                      This Anniversary, treat the special women in your life to an unforgettable dining experience at Kaboul Gourmet. Our chefs have crafted a special menu that celebrates the warmth and love of Anniversary everywhere.
                      <br />
                      <br />
                      Our elegant Anniversary Menu features traditional Afghan delicacies with contemporary twists, including a complimentary glass of champagne for all Anniversary. From our signature kabuli pulao to decadent desserts, every dish is prepared with care and the finest ingredients.
                      <br />
                      <br />
                      As a special touch, all Anniversary will receive a small gift to commemorate the occasion. Reserve your table now to secure your place for this popular celebration.
                    </p>
                  </FadeIn>
