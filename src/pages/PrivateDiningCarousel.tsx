        ...
        <div className="text-center mb-16 space-y-4">
          ...
          <FadeIn delay={0.5} direction="up" duration={0.8} once={true}>
            <p className="mt-4 text-sm md:text-base text-black max-w-2xl mx-auto text-center">
              Whether it's an intimate dinner or a full-scale celebration for up
              to 150 guests, we create unforgettable experiences tailored to
              every occasion.
            </p>
          </FadeIn>
                  ...
                  <div className="relative h-[300px] md:h-[400px] overflow-hidden">
                    ...
                    <div className="absolute inset-0 flex flex-col justify-center items-center text-white p-6">
                      ...
                      <div className="flex flex-col sm:flex-row gap-4">
                        <Button
                          onClick={() =>
                            window.open(room.getInTouchLink, "_blank")
                          }
                          variant="outline"
                        ...
                        <Button
                          onClick={() =>
                            window.open(room.exploreLink, "_blank")
                          }
                          variant="outline"
                          className="border-white text-white bg-transparent hover:bg-white hover:text-[#c6a87a] uppercase tracking-wider"
                        >
